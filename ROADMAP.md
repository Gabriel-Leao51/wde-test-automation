...
- [ ] **Track 5** — Remaining targeted UI-pattern features:
  ...
  - [ ] 5c. Sortable admin orders table
  - [ ] 5d. Date picker (product `launchDate`)
  - [ ] 5e. Drag-and-drop product image upload
  - [ ] 5f. Rich text editor for product description
  - [ ] 5g. PDF invoice download

...
Both fixes verified with 3+ repeated full-suite runs (`-n 2`/`-n 4`, matching CI exactly) on all three browsers before re-pushing - zero failures across every run, not just one lucky pass.
